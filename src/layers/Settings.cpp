...
SettingNode *SettingClickValue::createNode(float width) { return SettingClickNode::create(this, width); }
...
SettingNode *SettingReleaseValue::createNode(float width) { return SettingReleaseNode::create(this, width); }
