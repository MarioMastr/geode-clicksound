...
protected:
    bool init(SettingClickValue *value, float width)
    {
        ...
        // auto infoBtn
        auto testBtn = CCMenuItemSpriteExtra::create(playSpr, this, menu_selector(SettingClickNode::onClickBtn));
...
protected:
    bool init(SettingReleaseValue *value, float width)
    {
        ...
        playSpr->setScale(.650F);
        // auto infoBtn
        auto testBtn = CCMenuItemSpriteExtra::create(playSpr, this, menu_selector(SettingReleaseNode::onReleaseBtn));
        testBtn->setPositionX(143);
        menu->setPosition(width / 2, 18.f);
        menu->addChild(label);
        menu->addChild(testBtn);
